<template>
  <div class='home'>
    ...
    <div class="swiper">
        <mt-swipe :auto="4000">
            <mt-swipe-item >
                <video style="width=50%" muted controls="controls" autoplay src="../../../static/iphone.mp4"></video>
            </mt-swipe-item>
            <mt-swipe-item >
              <img src="../../../static/img/iphone-13-og-2021.jpg"></img>
            </mt-swipe-item >
        </mt-swipe>
    </div>
    <div class="icon">
